          ...
          <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-300">
            <div className="flex items-center justify-between bg-green-500/10 border border-green-500/20 p-6 rounded-2xl">
               <div className="flex items-center gap-4">
                  ...
                  <div>
                     <h3 className="text-xl font-bold text-white">Все системы работают штатно</h3>
                     <p className="text-green-400 text-sm">Инцидентов не обнаружено</p>
                  </div>
               </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
               {[
                 ...
                 <div key={idx} className="bg-[#151921] border border-brand-border p-4 rounded-xl flex items-center justify-between group hover:border-green-500/50 transition-colors">
                    <div className="flex items-center gap-3">
                       <div className="p-2 bg-white/5 rounded-lg text-brand-muted group-hover:text-white transition-colors">
            ...
            <div className="bg-[#151921] border border-brand-border p-6 rounded-2xl">
        ...
        return (
          <div className="space-y-6 max-w-2xl mx-auto">
             <div className="text-center mb-8">
                ...
                <h2 className="text-2xl font-bold text-white">Как мы можем помочь?</h2>
                <p className="text-brand-muted mt-2">Наша команда отвечает в течение 24 часов.</p>
             </div>

             <div className="bg-[#151921] border border-brand-border rounded-xl p-6">
                <h3 className="font-bold text-white mb-4">Частые вопросы</h3>
      ...
      case 'terms':
        return (
          <div className="space-y-4 text-brand-muted text-sm leading-relaxed max-w-3xl mx-auto">
             ...
             <h3 className="text-white font-bold text-lg mt-6">1. Введение</h3>
             ...
             <h3 className="text-white font-bold text-lg mt-6">2. Лицензия на контент</h3>
             ...
             <h3 className="text-white font-bold text-lg mt-6">3. Оплата и подписки</h3>
             ...
             <h3 className="text-white font-bold text-lg mt-6">4. Запрещенный контент</h3>
      ...
      case 'privacy':
        return (
          <div className="space-y-4 text-brand-muted text-sm leading-relaxed max-w-3xl mx-auto">
             ...
             <h3 className="text-white font-bold text-lg mt-6">1. Сбор данных</h3>
             ...
             <h3 className="text-white font-bold text-lg mt-6">2. Использование данных</h3>
             ...
             <h3 className="text-white font-bold text-lg mt-6">3. Безопасность</h3>
             <p>Мы используем шифрование SSL/TLS и алгоритмы AES-256 для защиты ваших данных. Доступ к системам строго ограничен.</p>
             <h3 className="text-white font-bold text-lg mt-6">4. Удаление данных</h3>
  ...
  return (
    <div className="fixed inset-0 z-[120] flex items-center justify-center p-4">
      <div 
        ...
        onClick={onClose}
      />
      <div className="relative w-full max-w-4xl bg-[#0B0E14] border border-brand-border rounded-2xl shadow-2xl flex flex-col h-[85vh] animate-in zoom-in-95 duration-300">
         <div className="p-4 border-b border-brand-border flex justify-end shrink-0">
            <button onClick={onClose} className="p-2 text-brand-muted hover:text-white bg-white/5 hover:bg-white/10 rounded-lg transition-colors">
               <X className="w-5 h-5" />
            </button>
         </div>
